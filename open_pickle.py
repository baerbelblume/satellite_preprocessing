...
data_set = '/home/bmetzler/Documents/Imagery/Accra/preprocessed/tif_cut_file/rgb/'
...
with open("/home/bmetzler/Documents/GitHub/deepcluster-master/exp/kmeans4_4/clusters", "rb") as f:
    b = pickle.load(f)
    print (b[-1], max(b[-1]))
